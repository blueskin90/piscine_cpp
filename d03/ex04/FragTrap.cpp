...
{
	std::cout << "FR4G-TP " << this->_name << " attacks " << target << " with grenades, dealing " << this->_rangedDamage << " explosives damages !" << std::endl;
}

void			FragTrap::meleeAttack(std::string const &target) const
{
	std::cout << "FR4G-TP " << this->_name << " attacks " << target << " with a knife, dealing " << this->_meleeDamage << " serrated damages." << std::endl;
}
